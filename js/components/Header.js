 ...
 * Civil 1st Semester এর জন্য simplified
 */

export const Header = {
  render({ title, subtitle, showBack = false } = {}) {
    if (showBack) {
      return `
      ...
      <header class="app-header">
        <div class="header-brand">
          ...
          <div class="header-title-box">
            ...
            <span class="header-app-badge">🏗️ Civil • 1st Semester</span>
          </div>
        </div>
        <div class="header-actions">
          <button class="header-icon-btn" id="header-settings-btn" aria-label="Settings" title="Settings">
  ...
  bindEvents(container) {
    ...
    container.querySelector("#header-settings-btn")?.addEventListener("click", () => {
      ...
      import("../core/comingSoonHelper.js").then((m) => m.showComingSoon("Settings"));
    });
  }
};